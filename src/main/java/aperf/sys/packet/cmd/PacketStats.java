...
public class PacketStats extends BaseCommand {
    ...
    @Command(name = "aperf", syntax = "(?:packet|p)", description = "Packet command menu", permission = "aperf.cmd.packet.commands", isPrimary = true)
    ...
    @Command(name = "aperf", syntax = "(?:packet|p) (?:stat|s)", description = "Starts/Shows packet collection info for you", permission = "aperf.cmd.packet.stat.self", isPlayerOnly = true)
    ...
    @Command(name = "aperf", syntax = "(?:packet|p) (?:stat|s) <name>", description = "Starts/Shows packet collection info for player", permission = "aperf.cmd.packet.stat.other")
