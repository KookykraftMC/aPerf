...
public class Filter extends ArrayList<SubFilter> {
     ...
     * 
     */
	private static final long serialVersionUID = 8415756513383295178L;
	...
	public boolean hits(Entity e, boolean all) {
		return hits(System.identityHashCode(e), EntityHelper.getEntityName(e), EntityHelper.getEntityType(e), e.getClass(), EntityHelper.getEntityClass(e), EntityHelper.getEntityLClass(e), e.dimension, (int) e.posX, (int) e.posY, (int) e.posZ, all);
	}
