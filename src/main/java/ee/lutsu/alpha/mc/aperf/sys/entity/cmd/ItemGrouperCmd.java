...
public class ItemGrouperCmd extends BaseCommand {
    ...
    public void status(Object plugin, ICommandSender sender, Map<String, String> args) {
        ...
        msg(sender, "%sItem grouping     [%s1%s]: %s%3s%s, XP orb grouping      [%s2%s]: %s%3s", ChatColor.GREEN, ChatColor.DARK_PURPLE, ChatColor.GREEN, m.groupItems ? ChatColor.DARK_GREEN : ChatColor.RED, m.groupItems ? "on" : "off", ChatColor.GREEN, ChatColor.DARK_PURPLE, ChatColor.GREEN, m.groupExpOrbs ? ChatColor.DARK_GREEN : ChatColor.RED, m.groupExpOrbs ? "on" : "off");

        msg(sender, "%sMatch range       [%s3%s]: %s%s%s, Move to new location [%s4%s]: %s%3s", ChatColor.GREEN, ChatColor.DARK_PURPLE, ChatColor.GREEN, ChatColor.DARK_GREEN, m.matchRange, ChatColor.GREEN, ChatColor.DARK_PURPLE, ChatColor.GREEN, ChatColor.DARK_GREEN, m.moveToNewLocation ? "yes" : "no ");

        msg(sender, "%sLived for atleast [%s5%s]: %s%3d%s, Run every x'th tick  [%s6%s]: %s%3d", ChatColor.GREEN, ChatColor.DARK_PURPLE, ChatColor.GREEN, ChatColor.DARK_GREEN, m.livedAtleast, ChatColor.GREEN, ChatColor.DARK_PURPLE, ChatColor.GREEN, ChatColor.DARK_GREEN, m.skipForTicks);
