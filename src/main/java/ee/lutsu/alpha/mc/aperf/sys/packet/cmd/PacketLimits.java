...
public class PacketLimits extends BaseCommand {
    ...
    @Command(name = "aperf", syntax = "(?:packet|p) (?:limit|l) clear", description = "Removes all your limits", permission = "aperf.cmd.packet.limit.clear", isPlayerOnly = true)
    ...
    @Command(name = "aperf", syntax = "(?:packet|p) (?:limit|l) on", description = "Enable your packet limits", permission = "aperf.cmd.packet.limit.on", isPlayerOnly = true)
    ...
    @Command(name = "aperf", syntax = "(?:packet|p) (?:limit|l) off", description = "Disable your packet limits", permission = "aperf.cmd.packet.limit.off", isPlayerOnly = true)
    ...
    @Command(name = "aperf", syntax = "(?:packet|p) (?:limit|l) dup", description = "Toggle duplicate packet sending mode", permission = "aperf.cmd.packet.limit.dup", isPlayerOnly = true)
    public void switchDuplicate(Object plugin, ICommandSender sender, Map<String, String> args) throws Exception {
        ...
        msg(sender, "Diggest packet limits are now %s", diggestActiveFlag == 0 ? "§4OFF§a" : diggestActiveFlag == 1 ? "§ePLUGINS only§a" : diggestActiveFlag == 2 ? "§eMC only§a" : "§2ALL§a");
    }

    @Command(name = "aperf", syntax = "(?:packet|p) (?:limit|l) help", description = "Show detailed help on limits", permission = "aperf.cmd.packet.limit.help")
    ...
    @Command(name = "aperf", syntax = "(?:packet|p) (?:limit|l)", description = "Shows your packet limits", permission = "aperf.cmd.packet.limit.list", isPlayerOnly = true)
